                   ...
                   <Cell col={4}>
                        <div className="col-left">
                          ...
                          <h2 style={{paddingTop: "2rem", fontFamily: 'Anton'}}> TUNDE ADEBANJO </h2>
                            ...
                            <p> " Life is scripted by the summation of choices made " </p>
                            <h4>Email Address </h4>
                            <h5> tundeadebanjo246@gmail.com</h5>
                            <h4> Phone </h4>
                            <h5>(234)8023397367</h5>
                            <h4> Blogsite</h4> 
                            <h5>https//tundeadebanjo246.blogspot.com </h5>
                            <hr style={{borderTop:" 5px solid #235671f", width: "50%", margin:"auto"}}/>
                    ...
                    <Experience
                        startYear= {2008}
                        endYear= {2008}
                        jobName= "URBAN DEVELOPMENT COMMISSION (UDC)  Bridgetown, Barbados"
                        
                        description="IT support Assistant Manager / Account Clerical Officer"
                        /> 
                         <hr style={{borderTop: "2px solid red", margin: "auto", width:"70%"}} />
                         <h3> SKILLS </h3>
                         <Skills  
