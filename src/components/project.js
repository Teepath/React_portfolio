        ...
        if(this.state.activeTab===0){
            return(
                <div className="project-grid">
                    ...
                    <CardText>  React, Redux, MongoDB and NodeJs </CardText>
                    <CardActions border>
                    <a href="ttps://github.com/Teepath/screemApp" target="_blank" rel="noopener noreferrer nofollow"><Button colored>Github</Button></a>
                        <a href="https://my-project-1502471900890.firebaseapp.com/login" target="_blank" rel="noopener noreferrer nofollow"><Button colored> Live Demo</Button></a>
                    </CardActions>
                ...
                <Card shadow={5} style={{minWidth:'450', margin:'0 auto'}} >
                    <CardTitle style={{color:'black', height:'176px', 
                    background:
                    'url()'}}>React/Nodejs Project #2</CardTitle>
                    <CardText> React, Redux and Node </CardText>
                    <CardActions border>
                    ...
                    <a href="https://github.com/Teepath/BookStoreApp" target="_blank" rel="noopener noreferrer nofollow"><Button colored>Github</Button></a>
                        <a href="https://newbkeview.herokuapp.com" target="_blank" rel="noopener noreferrer nofollow"><Button colored> Live Demo</Button></a>
                ...
                <Card shadow={5} style={{minWidth:'450', margin:'0 auto'}} >
                    ...
                    <a href="" target="_blank" rel="noopener noreferrer nofollow"><Button colored>Github</Button></a>
                        <a href="https://nbaapp-cddc9.firebaseapp.com/" target="_blank" rel="noopener noreferrer nofollow"><Button colored> Live Demo</Button></a>
